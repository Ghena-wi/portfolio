    ...
    <div class="col-auto">
       ...
       <div class="col-auto">
        <h2 style="font-family: Cairo, sans-serif;">Students</h2>
                            ...
                            <h4 class="card-title" style="font-family: Cairo, sans-serif;"></h4><a class="btn btn-light active text-white shadow-lg regb" role="button" href="https://onlinefse.com/application3.php" style="font-size: 20px;font-weight: 100;background-color: white;font-family: Cairo, sans-serif;padding: 15px 50px;margin-top: 25px;color: #96938e!important;">Register</a></div>
                    </div>
                </div>
...
20% OFF
    ...
    <div class="col-auto">
        <h2 style="font-family: Cairo, sans-serif;">Students</h2>
                            ...
                            <h4 class="card-title" style="font-family: Cairo, sans-serif;"></h4><a class="btn btn-light active text-white shadow-lg regb" role="button" href="https://onlinefse.com/application2.php" style="font-size: 20px;font-weight: 100;background-color: white;color:#8cd600!important;font-family: Cairo, sans-serif;padding: 15px 50px;margin-top: 25px;">Register</a></div>
                    </div>
                </div>
  ...
  10% OFF
    ...
    <div class="col-auto">
        <h2 style="font-family: Cairo, sans-serif;">One student</h2>
                            ...
                            <h4 class="card-title" style="font-family: Cairo, sans-serif;"></h4><a class="btn btn-light active text-white shadow-lg regb" role="button" href="https://onlinefse.com/application1.php" style="font-size: 20px;font-weight: 100;background-color: white;color:#0051ba!important;font-family: Cairo, sans-serif;padding: 15px 50px;margin-top: 25px;">Register</a></div>
                    </div>
                </div>
            </div>
        </div>

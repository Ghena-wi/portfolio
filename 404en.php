...
<body style="font-family: 'Cairo';">
        ...
        <div  style="background-image: url(&quot;assets/img/niu-iork-ssha-statuia-svobody-1.jpg&quot;);background-position: top;background-size: cover;">
  ...
  <nav class="navbar navbar-light navbar-expand-md bg-light navigation-clean" style="background-color: rgba(255,255,255,0)!important;opacity: 1;margin: 0px;">
      ...
      <span class="text-uppercase font-weight-bold"></span></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1" style="color: white!important;"><span class="sr-only" style="color: rgb(255,255,255);">Toggle navigation</span><span class="navbar-toggler-icon" style="color: rgb(248,248,248)!important;filter: brightness(115%) contrast(74%);"></span></button>
        ...
        </nav>   <div style="height:599px;">
        <div class="container hero">
            <div class="row text-right d-xl-flex justify-content-center">
                <div class="col-12 col-lg-6 col-xl-6 offset-xl-1" style="margin-left:0px;padding-top:100px;color:white;">
                    <h1 style="font-size: 60px;font-family: Cairo, sans-serif;margin: 11px;" class="text-center">404</h1>
                <h1 class="text-center" style="font-size: 45px;font-family: Cairo, sans-serif;margin: 11px;">Page Not Found</h1>
                 </div>
            </div>
        </div>
    </div>

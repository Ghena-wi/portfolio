      ...
      <span class="text-uppercase font-weight-bold"></span></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1" style="color: white!important;"><span class="sr-only" style="color: rgb(255,255,255);">Toggle navigation</span><span class="navbar-toggler-icon" style="color: rgb(248,248,248)!important;filter: brightness(115%) contrast(74%);"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav text-right">
                             <li class="nav-item text-right" role="presentation" style="font-size: 25px;"><a class=" btn btn-link " href="https://onlinefse.com/application3.php?la=eng" style="color: rgb(255,255,255);font-family: Cairo, sans-serif;font-size: 20px;">English</a></li>
     ...
     <div class="register-photo" style="margin-top: -150px;background-color: rgba(241,247,252,0);">
        <div class="form-container">
            <form class="text-center border rounded shadow" method="POST"  action="app3session.php">
                  <h1 style="font-family: Cairo, sans-serif;font-size:30px;color: rgb(80,94,108);">نموذج تسجيل مجموعة من 8 طلبة<h1>
                ...
                <div class="form-row">
                    <div class="col col-12 col-lg-6 col-md-6 order-xs-12 order-lg-1 order-md-1" style="padding: 10px;">
                        <div style="height: 33px;"></div>
                        <div class="form-group text-right"><label style="color: #282821;">إسم المجموعة</label><input class="form-control text-right" type="text" name="group_name" required=""  id="group_name" onfocusout="checkGname()">
        ...
        <button  type="button"   class="btn btn-link" data-toggle="popover"  data-placement="bottom" data-trigger="focus"   data-content="يمكن للطالب فهم واستخدام التعبيرات اليومية المألوفة والعبارات الأساسية للغاية بحيث يمكنه تقديم نفسه / نفسها ، ويمكنه طرح أسئلة حول التفاصيل الشخصية والإجابة عنها، كذلك يمكن الطالب من التفاعل بطريقة بسيطة مع شخص اخر"
        >؟</button>
        ...
        >؟</button>
                    ...
                    <div class="col col-12 col-lg-6 col-md-6 order-1 order-lg-12 order-md-12" style="padding: 10px;">
                        <div role="tablist" id="accordion-1">
                          ...
                          <input class="form-control text-right" type="text" name="Country1" required="" placeholder="البلد"> 
                                    ...
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city1" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                                        <input class="form-control text-right" type="text" name="postal1"  required="" placeholder="الرمز البريدي "></div>
                                    <div style="height: 33px;"></div>
                          ...
                          <input class="form-control text-right" type="text" name="Country2" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city2" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                       ...
                       <div class="form-group text-right"><label style="color: #282821;">البلد</label>
                          <input class="form-control text-right" type="text" name="Country3" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city3" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                                     <input class="form-control text-right" type="text" name="postal3"  required=""  placeholder="الرمز البريدي "></div>
                                    <div style="height: 33px;"></div>
             ...
             <div class="card">
                     ...
                     <div class="form-group text-right"><label style="color: #282821;">البلد</label>
                          <input class="form-control text-right" type="text" name="Country4" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city4" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                             ...
                             <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="true" aria-controls="accordion-1 .item-5" href="div#accordion-1 .item-5" style="font-family: Cairo, sans-serif;color: #0038a8;">بيانات الطالب 5</a></h5>
                                </div>
                                <div class="collapse item-5" role="tabpanel" data-parent="#accordion-1">
                                    <div class="card-body">
                                        <div class="form-group text-right"><label style="color: #282821;">إسم الطالب</label><input class="form-control text-right" type="text" name="first_name5" required="" placeholder="الإسم الأول "></div>
                                        <div class="form-group text-right"><input class="form-control text-right" type="text" name="last_name5" required="" placeholder="اللقب"></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">تاريخ الميلاد</label><input class="form-control text-center" type="date" name="bday5" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">الجنس</label>
                                            <div><label style="margin: 5px;">ذكر</label><input type="radio" name="gender5" value="male" required=""></div>
                                            <div><label style="margin: 5px;">أنثى</label><input type="radio" name="gender5" value="female"></div>
                                        </div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">رقم الهاتف</label><input class="form-control d-inline-flex" type="tel" name="phone_num5" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label style="color: #282821;">البريد الإلكتروني</label><input class="form-control" type="email" name="email5" required=""></div>
                                        <div style="height: 33px;"></div>
                        <div class="form-group text-right"><label style="color: #282821;">البلد</label>
                          <input class="form-control text-right" type="text" name="Country5" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city5" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                                      <input class="form-control text-right" type="text" name="postal5" required=""  placeholder="الرمز البريدي "></div>
                                    <div style="height: 33px;"></div>
                              ...
                              <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-1 .item-6" href="div#accordion-1 .item-6" style="font-family: Cairo, sans-serif;color: #0038a8;">بيانات الطالب 6</a></h5>
                                </div>
                                <div class="collapse item-6" role="tabpanel" data-parent="#accordion-1">
                                    <div class="card-body">
                                        <div class="form-group text-right"><label style="color: #282821;">إسم الطالب</label><input class="form-control text-right" type="text" name="first_name6" required="" placeholder="الإسم الأول "></div>
                                        <div class="form-group text-right"><input class="form-control text-right" type="text" name="last_name6" required="" placeholder="اللقب"></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">تاريخ الميلاد</label><input class="form-control text-center" type="date" name="bday6" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">الجنس</label>
                                            <div><label style="margin: 5px;">ذكر</label><input type="radio" name="gender6" value="male" required=""></div>
                                            <div><label style="margin: 5px;">أنثى</label><input type="radio" name="gender6" value="female"></div>
                                        </div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">رقم الهاتف</label><input class="form-control d-inline-flex" type="tel" name="phone_num6" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label style="color: #282821;">البريد الإلكتروني</label><input class="form-control" type="email" name="email6" required=""></div>
                                        <div style="height: 33px;"></div>
                 <div class="form-group text-right"><label style="color: #282821;">البلد</label>
                          <input class="form-control text-right" type="text" name="Country6" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city6" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                                      <input class="form-control text-right" type="text" name="postal6" required=""  placeholder="الرمز البريدي "></div>
                                    <div style="height: 33px;"></div>
                         ...
                         <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-1 .item-7" href="div#accordion-1 .item-7" style="font-family: Cairo, sans-serif;color: #0038a8;">بيانات الطالب 7</a></h5>
                                </div>
                                <div class="collapse item-7" role="tabpanel" data-parent="#accordion-1">
                                    <div class="card-body">
                                        <div class="form-group text-right"><label style="color: #282821;">إسم الطالب</label><input class="form-control text-right" type="text" name="first_name7" required="" placeholder="الإسم الأول "></div>
                                        <div class="form-group text-right"><input class="form-control text-right" type="text" name="last_name7" required="" placeholder="اللقب"></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">تاريخ الميلاد</label><input class="form-control text-center" type="date" name="bday7" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">الجنس</label>
                                            <div><label style="margin: 5px;">ذكر</label><input type="radio" name="gender7" value="male" required=""></div>
                                            <div><label style="margin: 5px;">أنثى</label><input type="radio" name="gender7" value="female"></div>
                                        </div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">رقم الهاتف</label><input class="form-control d-inline-flex" type="tel" name="phone_num7" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label style="color: #282821;">البريد الإلكتروني</label><input class="form-control" type="email" name="email7" required=""></div>
                                        <div style="height: 33px;"></div>
                  <div class="form-group text-right"><label style="color: #282821;">البلد</label>
                          <input class="form-control text-right" type="text" name="Country7" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city7" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                                      <input class="form-control text-right" type="text" name="postal7" required=""  placeholder="الرمز البريدي "></div>
                                    <div style="height: 33px;"></div>
             ...
             <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-1 .item-8" href="div#accordion-1 .item-8" style="font-family: Cairo, sans-serif;color: #0038a8;">بيانات الطالب 8</a></h5>
                                </div>
                                <div class="collapse item-8" role="tabpanel" data-parent="#accordion-1">
                                    <div class="card-body">
                                        <div class="form-group text-right"><label style="color: #282821;">إسم الطالب</label><input class="form-control text-right" type="text" name="first_name8" required="" placeholder="الإسم الأول "></div>
                                        <div class="form-group text-right"><input class="form-control text-right" type="text" name="last_name8" required="" placeholder="اللقب"></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">تاريخ الميلاد</label><input class="form-control text-center" type="date" name="bday8" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">الجنس</label>
                                            <div><label style="margin: 5px;">ذكر</label><input type="radio" name="gender8" value="male" required=""></div>
                                            <div><label style="margin: 5px;">أنثى</label><input type="radio" name="gender8" value="female"></div>
                                        </div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label class="text-right" style="color: #282821;">رقم الهاتف</label><input class="form-control d-inline-flex" type="tel" name="phone_num8" required=""></div>
                                        <div style="height: 33px;"></div>
                                        <div class="form-group text-right"><label style="color: #282821;">البريد الإلكتروني</label><input class="form-control" type="email" name="email8" required=""></div>
                                        <div style="height: 33px;"></div>
                      <div class="form-group text-right"><label style="color: #282821;">البلد</label>
                          <input class="form-control text-right" type="text" name="Country8" required="" placeholder="البلد"> 
                                        ...
                                        <div
                                            style="height: 33px;"></div>
                                    <div class="form-group text-right"><label style="color: #282821;">العنوان</label><input class="form-control text-right" type="text" name="city8" required="" placeholder="إسم المدينة">             </div><div class="form-group text-right">
                                       <input class="form-control text-right" type="text" name="postal8" required=""  placeholder="الرمز البريدي "></div>
                                    <div style="height: 33px;"></div>

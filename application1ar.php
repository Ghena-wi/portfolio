      ...
      <span class="text-uppercase font-weight-bold"></span></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1" style="color: white!important;"><span class="sr-only" style="color: rgb(255,255,255);">Toggle navigation</span><span class="navbar-toggler-icon" style="color: rgb(248,248,248)!important;filter: brightness(115%) contrast(74%);"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav text-right">
                             <li class="nav-item text-right" role="presentation" style="font-size: 25px;"><a class=" btn btn-link " href="https://onlinefse.com/application1.php?la=eng" style="color: rgb(255,255,255);font-family: Cairo, sans-serif;font-size: 20px;">English</a></li>
    ...
    <div class="register-photo" style="margin-top: -150px;background-color: rgba(241,247,252,0);">
        <div class="form-container">
            <form class="text-center border rounded shadow"  method="POST" action="app1session.php">
                 <h1 style="font-family: Cairo, sans-serif;font-size:30px;color: rgb(80,94,108);">نموذج تسجيل طالب منفرد <h1>
                ...
                <div class="form-row text-right" id="infoSection">
                    <div class="col col-12 col-md-6 col-lg-6 order-lg-12 order-md-12">
                        <div style="height: 33px;"></div>
                         <div class="form-group text-right"><label style="color: #282821;">ما البرنامج الذي ترغب &nbsp;في التسجيل به ؟</label>
        ...
        <button  type="button" class="btn btn-link" data-toggle="popover" data-trigger="focus"  data-placement="left"  data-content="يمكن للطالب فهم واستخدام التعبيرات اليومية المألوفة والعبارات الأساسية للغاية بحيث يمكنه تقديم نفسه / نفسها ، ويمكنه طرح أسئلة حول التفاصيل الشخصية والإجابة عنها، كذلك يمكن الطالب من التفاعل بطريقة بسيطة مع شخص اخر"
        >؟</button>
        ...
        <button type="button" class="btn btn-link" data-toggle="popover" data-trigger="focus" data-placement="left"  data-content="يمكن للطالب فهم النقاط الرئيسية الواضحة بشأن الأمور المألوفة التي تتم مواجهتها بإنتظام في العمل والمدرسة والترفيه وما إلى ذلك. يمكن أن يتعامل مع معظم المواقف التي يحتمل أن تنشأ أثناء السفر في منطقة يتم فيها التحدث باللغة. يمكن أن ينتج نصًا بسيطًا متصلًا حول مواضيع مألوفة أو ذات أهمية شخصية "
        >؟</button>
                            ...
                            <div>
                                 <div id="advancedPop" >        
        <button  type="button" class="btn btn-link" data-toggle="popover"  data-trigger="focus"  data-placement="left"  data-content="يمكن للطالب أن يفهم مجموعة واسعة من النصوص الطويلة والتعرف على المعنى الضمني. يمكنه التعبير عن نفسه بطلاقة وتلقائية دون البحث عن التعبيرات. يمكن استخدام اللغة بمرونة وفعالية لأغراض اجتماعية وأكاديمية ومهنية. يمكن أن ينتج نصًا واضحًا منظمًا جيدًا ومفصلًا حول الموضوعات المعقدة "
        >؟</button>
                    ...
                    <input class="form-control text-right" type="text" name="city" required="" placeholder="إسم المدينة"></div>
                    <div class="form-group text-right">
                      <input class="form-control text-right" type="text" required=""  name="postal" placeholder="الرمز البريدي "></div>
                    <div style="height: 33px;"></div>
